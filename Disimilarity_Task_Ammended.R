...
#1. The difference is that number of columns ncol() counts the number of columns, while the pooled
#function diversity result calculates the species richness across all the columns. i.e.
#calculates the diversity of the entire community (all sites pooled).

#2.Pooled function is correct, because there is a column with a species that does not appear in
#any of the sites.
